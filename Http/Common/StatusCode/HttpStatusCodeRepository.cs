...
{
    /// <summary>
    /// This class implements the functionality used to access <see cref="HttpStatusCode" /> objects.
    /// </summary>
    public class HttpStatusCodeRepository : IHttpStatusCodeRepository
    {
        /// <inheritdoc />
        public HttpStatusCode GetStatusCode(int statusCodeValue)
        {
            try
            {
            ...
            {
                throw new UnknownHttpStatusCodeException($"Unknown HTTP status-code: {statusCodeValue}.");
            }
        }
        ...
        private static readonly IDictionary<int, HttpStatusCode> KnownStatusCodes = new Dictionary<int, HttpStatusCode>
        {
            // Informational
            /// <summary>
            ...
            /// </summary>
            { 101, new HttpStatusCode(101) },

            // Successful
            /// <summary>
            /// The 200 (OK) status code indicates that the request has succeeded.
            /// </summary>
            { 200, new HttpStatusCode(200) },
            ...
            /// resource.
            /// </summary>
            { 401, new HttpStatusCode(401) },

            /// <summary>
            /// The 402 (Payment Required) status code is reserved for future use.
            /// </summary>
            { 402, new HttpStatusCode(402) },
